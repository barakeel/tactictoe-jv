...
\item Minimization and embellishment of the generated proof  facilitates user
interaction.
\end{itemize}
...
\caption{Relation between modules of the learning and proving tool chains.
Functions are represented by rectangles and objects by ellipses.}
\end{figure}
...
in Section~\ref{sec:recording}. Based on such training examples, we
  ...
  similarity measures computed in Section~\ref{sec:features} from syntactic 
  features of mathematical formulas .
