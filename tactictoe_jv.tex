...
\todo{JU: Still feels more like an intro than an abstract. Could be shorter and punchier.}
\begin{abstract}
...
library show that TacticToe is able to re-prove 59\% of the 7088 theorems in less 
than 10 seconds compared to 29\% proved by the HolyHammer system using the E ATP in its auto-schedule mode.
