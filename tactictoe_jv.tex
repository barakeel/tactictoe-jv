...
The section order does not follow the implementation, because we have prioritized giving a description of
...
\begin{align*}
\mathit{Descendant}^{0}(a) &=_{\mathrm{def}} \lbrace a \rbrace \\
\mathit{Descendant}^{n+1}(a) &=_{\mathrm{def}} \bigcup_{a' \in \mathit{Descendant}^{n}(a)}
\mathit{Children}(a') \\
\mathit{Descendant}(a) &=_{\mathrm{def}} \bigcup_{n \in \mathbb{N}} \mathit{Descendant}^n(a)\\
\end{align*}
...
\[\mathit{CurEvaluation}(a_i) =
  \sum_{a' \in \mathit{Descendant}(a_i)} \frac{\mathit{PriorEvaluation}(a')} {card\
...
\[\textit{\mbox{Coverage}}(t) =_{\mathrm{def}} card\ \lbrace g\ |\ (t,g) \in
  \mathfrak{T} \rbrace \]
