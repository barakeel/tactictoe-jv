...
default parameters: features extraction, prediction 
algorithms, number of premises for ATPs and MCTS evaluation radius (set to 
10).
...
strategy with the highest number of proven theorems is selected for 
