...
When \tactictoe finds a proof of a goal, it returns a search tree 
$\mathfrak{T}$ where the root node containing this goal is solved.
...
Here is a formal description of the transformation $Proof$ defined by mutual 
recursion on the goals and nodes of $\mathfrak{T}$:

%\begin{equation*}
%Proof(g) =_{def}
%\begin{cases}
%T(g) & \text{if $t$ is a root},\\
