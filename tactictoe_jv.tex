...
\todo{These 2 paragraphs are copied and slightly edited}
...
\node [left of=2, tcircle] (2l) {$g_2^1$};
\node [tcircle,right of=2] (2r) {$g_2^p$};
\node [draw, fit=(2l) (2r)] (2b) {}; 


\node [tcircle, left of=2l, node distance=2cm] (1r) {$g_1^q$};
\node [left of=1r] (1) {.\ .\ .};
\node [tcircle, left of=1] (1l) {$g_1^1$};
\node [draw, fit=(1l) (1r)] (1b) {}; 

\node [right of=2r,node distance=2cm] (3l) {$\phantom{g_3^p}$};
\node [right of=3l] (3) {\phantom{.\ .\ .}};
\node [right of=3] (3r) {$\phantom{g_3^p}$};
\node [fit=(3l) (3r)] (3b) {}; 

\draw[-to,thick] (0) to node[xshift=-10](t1){$t_1$} (1b);
\draw[-to,thick] (0) to node[xshift=-10](t2){$t_2$} (2b);
\draw[-to,dotted,thick] (0) to (3b);
\end{tikzpicture}
\end{center}
\caption{Choice of a goal and a tactic}
\label{fig:choice}
\end{figure}
...
Disclaimer:
Comparing results from different tables is possible but not advisable since 
conditions of the experiments may vary slightly because of various factors such 
