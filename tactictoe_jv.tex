...
\def\eprover{\textsf{Eprover}\xspace}
...
combining the results of TacticToe and Eprover.
\end{abstract}
...
Lists of goals that are a subset or equal to the result of a recorded tactic on 
a target goal are considered positive because if a set of goals is solvable 
then a subset of it is too. During proof search, given a list of
