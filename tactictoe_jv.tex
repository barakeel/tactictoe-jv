...
\begin{abstract}\todo{CK review + choose title}
...
\section{Introduction}\todo{TG + CK review}
...
\section{ATP Integration}\todo{JU + CK: rework and review}
...
motivations and transitions + review}
...
\section{Case study}\todo{TG: rerun experiment with prettification and 
minimization + add another example. 
  TG + RK: describe the two examples + find examples that did not appear during 
  evaluation
...
\section{Conclusion}\label{sec:concl}\todo{TG + JU review}
