...
\begin{definition}(Dependencies of tactic-goal pairs)\\
...
The dependencies $D_\infty$ of a theorem $t$ are the set of theorems in 
$\mathfrak{T}$ appearing in the proof $t$ as recorded in \cite{hh4h4}.
Contrarily to the dependency relation in tactic-goal pairs, this relation is 
...
step are chosen or discarded together. \todo{problematic forward reference?}
