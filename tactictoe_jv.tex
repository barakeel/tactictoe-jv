...
a possibly useful subsumption definition could be: \todo{shorter or equal}
...
to } g_2\]
\end{definition}
\todoi{@TG: Which of the two above?}
...
detailed description of the target goal.\todo{and can be used as an ATP}
