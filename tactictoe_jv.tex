...
To conclude, we also demonstrate the capabilities of \tactictoe on two goals 
that do not have a proof in \holfour. 
...
The second goal, in Example~, \todoi{TG to RK: I am not sure what the count 
constant is doing.}
