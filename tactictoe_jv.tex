...
TacticToe proves 66.2\% of 7164 theorems of the standard library where as 
...
\todo{mention preselection and which dataset of objects?}

We use $sim_1$ for goals and theorems and $sim_2$ for terms and list of goals.
...
\subsection{Slight improvements}\todo{maybe remove this subsection}
