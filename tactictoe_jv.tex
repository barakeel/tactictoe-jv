...
another ITP and warn about some of the issues that could arise during this work.
...
state of the ITP (i.e. flags), which rarely happens in \holfour. If the 
behavior of a tactic drastically changes under different context, then the part 
of the context that affects it should become part of the tactic.
