...
tactics can prove a wide range of theorems. In this respect, if we omit the 
abstraction technique, \tactictoe is not synthesizing any tactic but simply 
selecting them out of large tactic set. In the end, proof planning methodology 
may become necessary for improving \tactictoe as it provides a way to generate 
tactic applicable to a 
large range of formulas. And more general tactics are usually easier to predict 
